...
ActiveRecord::Schema.define(version: 20160603165715) do
  ...
  create_table "country_captains", force: :cascade do |t|
    t.text     "ask_me"
  ...
  create_table "registration_for_mailing_lists", force: :cascade do |t|
    t.integer  "class_of"
    t.text     "phone"
    t.text     "email"
